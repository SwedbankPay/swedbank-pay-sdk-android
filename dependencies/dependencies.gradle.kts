...
extra["libs"] = mapOf(
   "android-gradle-plugin" to "com.android.tools.build:gradle:7.2.1",   //7.1.3

   "jgit" to "org.eclipse.jgit:org.eclipse.jgit:6.2.0.202206071550-r",

   "kotlinx-coroutines-core" to "org.jetbrains.kotlinx:kotlinx-coroutines-core:1.6.3",
   "kotlinx-coroutines-android" to "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.6.3",
   "kotlinx-serialization-json" to "org.jetbrains.kotlinx:kotlinx-serialization-json:1.3.3",

   "androidx-appcompat" to "androidx.appcompat:appcompat:1.4.2",
   "androidx-core-ktx" to "androidx.core:core-ktx:1.8.0",
   "fragment-ktx" to "androidx.fragment:fragment-ktx:1.4.1",
   "fragment-testing" to "androidx.fragment:fragment-testing:1.4.1",
   "lifecycle-livedata-ktx" to "androidx.lifecycle:lifecycle-livedata-ktx:2.4.1",
   "lifecycle-viewmodel-ktx" to "androidx.lifecycle:lifecycle-viewmodel-ktx:2.4.1",
   ...
   "navigation-fragment" to "androidx.navigation:navigation-fragment:2.4.2",
   ...
   "play-services-base" to "com.google.android.gms:play-services-base:18.0.1",
   "play-services-basement" to "com.google.android.gms:play-services-basement:18.0.2",
