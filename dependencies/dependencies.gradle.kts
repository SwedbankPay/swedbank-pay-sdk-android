...
extra["libs"] = mapOf(
   "android-gradle-plugin" to "com.android.tools.build:gradle:7.3.1",   //7.1.3
   ...
   "kotlinx-serialization-json" to "org.jetbrains.kotlinx:kotlinx-serialization-json:1.4.0",
