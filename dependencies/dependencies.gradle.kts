...
extra["libs"] = mapOf(
   ...
   "constraintlayout" to "androidx.constraintlayout:constraintlayout:2.1.1",
   ...
   "play-services-base" to "com.google.android.gms:play-services-base:17.6.0",
   "play-services-basement" to "com.google.android.gms:play-services-basement:17.6.0",
