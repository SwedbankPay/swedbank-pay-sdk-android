...
extra["libs"] = mapOf(
   ...
   "fragment-ktx" to "androidx.fragment:fragment-ktx:1.5.4",
   ...
   "espresso-intents" to "androidx.test.espresso:espresso-intents:3.5.0",
   ...
   "joda-time" to "joda-time:joda-time:2.12.2",
   ...
   "robolectric" to "org.robolectric:robolectric:4.9.1",
