...
extra["libs"] = mapOf(
   "android-gradle-plugin" to "com.android.tools.build:gradle:7.1.1",
   ...
   "navigation-fragment" to "androidx.navigation:navigation-fragment:2.4.0",
   ...
   "mockito-inline" to "org.mockito:mockito-inline:4.3.1",
