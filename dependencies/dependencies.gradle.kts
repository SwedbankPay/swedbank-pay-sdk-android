...
extra["libs"] = mapOf(
   "android-gradle-plugin" to "com.android.tools.build:gradle:7.3.0",   //7.1.3

   "jgit" to "org.eclipse.jgit:org.eclipse.jgit:6.3.0.202209071007-r",
   ...
   "androidx-appcompat" to "androidx.appcompat:appcompat:1.5.1",
   "androidx-core-ktx" to "androidx.core:core-ktx:1.8.0",
   "fragment-ktx" to "androidx.fragment:fragment-ktx:1.5.3",
   "fragment-testing" to "androidx.fragment:fragment-testing:1.5.2",
   ...
   "navigation-fragment" to "androidx.navigation:navigation-fragment:2.5.2",
   ...
   "joda-time" to "joda-time:joda-time:2.11.2",
   "threetenbp" to "org.threeten:threetenbp:1.6.1",
   ...
   "mockito-inline" to "org.mockito:mockito-inline:4.7.0",
