...
extra["libs"] = mapOf(
   ...
   "kotlinx-coroutines-android" to "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.6.1",
   ...
   "material" to "com.google.android.material:material:1.6.0",
   ...
   "mockito-inline" to "org.mockito:mockito-inline:4.6.0",
