...
import com.swedbankpay.mobilesdk.merchantbackend.internal.*
...
sealed class MerchantBackendProblem(jsonObject: JsonObject) : Problem(jsonObject) {
    ...
    sealed class Client(jsonObject: JsonObject) : MerchantBackendProblem(jsonObject) {
        companion object {
            @JvmField
            val CREATOR = object : Parcelable.Creator<Client> {
                override fun createFromParcel(source: Parcel) = source.readClientProblem()
                override fun newArray(size: Int) = arrayOfNulls<Client>(size)
            }
        }
    ...
    sealed class Server(jsonObject: JsonObject) : MerchantBackendProblem(jsonObject) {
        companion object {
            @JvmField
            val CREATOR = object : Parcelable.Creator<Server> {
                override fun createFromParcel(source: Parcel) = source.readServerProblem()
                override fun newArray(size: Int) = arrayOfNulls<Server>(size)
            }
        }
